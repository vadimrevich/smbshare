...
set MSG000ERR00=%~dp0Msg005.DownFiles.Err00.wsf
set MSG000ERR02=%~dp0Msg005.DownFiles.Err02.wsf
...
echo Check Files...
rem
if not exist %DnRnWSF% echo DnRnWSF is not found && goto Lab_Err02
if not exist %DnRnEXE% echo DnRnEXE is not found && goto Lab_Err02
