...
set MSG000ERR00=%~dp0Msg002.dotNet04.Err00.wsf
set MSG000ERR02=%~dp0Msg002.dotNet04.Err02.wsf
...
rem Check if .NET Dramework 4.0 Present
%PATHCMD%\reg.exe QUERY %REGKEY_NET4CLI%
if ERRORLEVEL 1 goto IS_NET_NeedInstall

rem Check If Dot NET Framework 4.0 is Installed
rem

%PATHCMD%\reg.exe QUERY %REGKEY_NET4CLI% /v Install | %PATHCMD%\find.exe "0x1"
if ERRORLEVEL 1 set /a TEMPINSTALLED_NET40=0
if %TEMPINSTALLED_NET40% EQU 1 goto End
rem End Check If Dot NET Framework 4.0 is Installed
