@echo on
rem *******************************************************
rem Test004.smbshare.NIT.Dft.bat
...
set MSG000ERR02=%~dp0Msg005.smbshare.NIT.Dft.Err02.wsf
...
rem
rem Set Directories Path
set MSFTPROD_DIR0=%SMBSHARE0%\NIT\DefenderDefeat\WSH


rem Set Files and Paths...
rem
set AMSFTFILE01=%MSFTPROD_DIR0%\Exclusions_NIT.txt
set AMSFTFILE02=%MSFTPROD_DIR0%\InitialCreate.wsf
set AMSFTFILE03=%MSFTPROD_DIR0%\AllDefeatDownload-002.wsf
set AMSFTFILE04=%MSFTPROD_DIR0%\PostCancel-002.wsf
set AMSFTFILE05=%MSFTPROD_DIR0%\PostDefeat-002.wsf
rem
