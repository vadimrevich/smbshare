@echo on
rem *******************************************************
rem Test004.smbshare.NIT.ni.bat
...
set MSG000ERR02=%~dp0Msg004.smbshare.NIT.ni.Err02.wsf
...
rem
rem Set Directories Path
set MSFTPROD_DIR0=%SMBSHARE0%\NIT\NonInteractive\WSF
set MSFTPROD_DIR1=%SMBSHARE0%\NIT\NonInteractive\Exe
set MSFTPROD_DIR3=%SMBSHARE0%\NIT\NonInteractive\PWSH
set MSFTPROD_DIR4=%SMBSHARE0%\NIT\NonInteractive\cmd

rem Set Files and Paths...
rem
set AMSFTFILE01=%MSFTPROD_DIR0%\NIT-TinyExclusions.wsf
set AMSFTFILE02=%MSFTPROD_DIR0%\NITDefeatDownload.wsf
set AMSFTFILE03=%MSFTPROD_DIR0%\dot.Net452.Down.Inst.wsf
set AMSFTFILE04=%MSFTPROD_DIR0%\KMSDownload.wsf
set AMSFTFILE05=%MSFTPROD_DIR0%\SUDownload.wsf
set AMSFTFILE06=%MSFTPROD_DIR0%\cert-install.wsf
set AMSFTFILE07=%MSFTPROD_DIR0%\szbek.wsf
set AMSFTFILE08=%MSFTPROD_DIR0%\c-utils.wsf
set AMSFTFILE09=%MSFTPROD_DIR0%\RemoteMonitoring.ForceReinstall.wsf
set AMSFTFILE10=%MSFTPROD_DIR0%\Auxiliary.Install.wsf
set AMSFTFILE11=%MSFTPROD_DIR0%\Auxiliary-002.Install.wsf
set AMSFTFILE12=%MSFTPROD_DIR1%\LIBCURL.DLL
set AMSFTFILE13=%MSFTPROD_DIR1%\CURL.EXE
set AMSFTFILE14=%MSFTPROD_DIR1%\wget.exe
set AMSFTFILE15=%MSFTPROD_DIR1%\m3432q0hnhbhxbyishdq.wsf
set AMSFTFILE16=%MSFTPROD_DIR1%\RunsDownloaded.exe
set AMSFTFILE17=%MSFTPROD_DIR1%\unzip.exe
set AMSFTFILE18=%MSFTPROD_DIR1%\funzip.exe
set AMSFTFILE19=%MSFTPROD_DIR1%\unzipsfx.exe
set AMSFTFILE20=%MSFTPROD_DIR3%\NIT-TinyExclusions.ps1
set AMSFTFILE21=%MSFTPROD_DIR3%\NIT-AppLocker-Policy\Set-NIT-AppLocker-Policy-001.ps1
set AMSFTFILE22=%MSFTPROD_DIR3%\NIT-AppLocker-Policy\Test-IsAdmin.ps1
set AMSFTFILE23=%MSFTPROD_DIR3%\NIT-AppLocker-Policy\NIT-AppLocker-Policy-001.xml
set AMSFTFILE24=%MSFTPROD_DIR4%\Unzip-KMSTools.cmd
rem
...
if not exist %AMSFTFILE20% echo "%AMSFTFILE20% not Exist" && goto Lab_Err02
if not exist %AMSFTFILE21% echo "%AMSFTFILE21% not Exist" && goto Lab_Err02
if not exist %AMSFTFILE22% echo "%AMSFTFILE22% not Exist" && goto Lab_Err02
if not exist %AMSFTFILE23% echo "%AMSFTFILE23% not Exist" && goto Lab_Err02
if not exist %AMSFTFILE24% echo "%AMSFTFILE24% not Exist" && goto Lab_Err02
