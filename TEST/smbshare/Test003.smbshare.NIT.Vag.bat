@echo on
rem *******************************************************
rem Test001.smbshare.files.bat
...
set MSG000ERR02=%~dp0Msg003.smbshare.NIT.Vag.Err02.wsf
...
rem
rem Set Directories Path
set MSFTPROD_DIR0=%SMBSHARE0%\NIT\Vagrant_Settings\Win

rem Set Files and Paths...
rem
set AMSFTFILE01=%MSFTPROD_DIR0%\create_vagrant_user.bat
set AMSFTFILE02=%MSFTPROD_DIR0%\IEHArden_V5.bat
set AMSFTFILE03=%MSFTPROD_DIR0%\WinRM2Unsafe.bat
set AMSFTFILE04=%MSFTPROD_DIR0%\Disable-PasswordComplexity.ps1
set AMSFTFILE05=%MSFTPROD_DIR0%\Enable-PasswordComplexity.ps1
set AMSFTFILE06=%MSFTPROD_DIR0%\TurnOffServerManager.reg
set AMSFTFILE07=%MSFTPROD_DIR0%\TurnOffShutdowsTracker.reg
rem
