...
rem For Windows 7/2K8R2 x64 only
...
set AFILE01=Windows6.1-KB2677070-x64.msu
set AFILE02=Windows6.1-KB2813430-x64.msu
set AFILE03=Windows6.1-KB3004394-v2-x64.msu
set AFILE04=Windows6.1-KB3063858-x64.msu
