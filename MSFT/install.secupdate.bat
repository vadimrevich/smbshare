...
set SECUPDATEDIR0=SecUpdate\W7W2K8R2
set MESSAGDIR=MESSAGES

rem Set Files and Paths...
set AFILE01=secupdate.install.bat
set AFILE02=MESSWIN7-SecUpdate01.wsf
set AFILE03=MESSWIN7-SecUpdate02.wsf
rem
...
set PRMESS02=%PRMESSDIR%\%AFILE03%
rem
...
if not exist %PRMESS02% echo %PRMESS02% not Found && exit /b 2
...
ver | %FINDEXE% "Windows [Version 6.1" > nul
if not errorlevel 1 goto win_7

:Not_WIN_7
%CSCRIPTEXE% //NoLogo %PRMESS02%
goto End
...
rem
set PRODUCTNAMEDIR=%~dp0%SECUPDATEDIR0%\%xOS%
