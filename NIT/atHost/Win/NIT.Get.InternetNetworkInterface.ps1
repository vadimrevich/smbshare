...
.DESCRIPTION
    Get All Windows Network Interfaces
    which has Default Internet Gateway
    on Windows 10.0 Local Computer
.NOTES
    File name: NIT.Get.InternetNetworkInterface.ps1
    VERSION: 1.0.0a
...
.VERSION HISTORY:
    1.0.0 - (2024-10-06) Script created
    1.0.1 - 
#>
...
function Main-Function {
    ...
    # Get Desired Objects
    #
    # $Objects = Get-PhysicalInterfaces
    $Objects = Get-Interfaces-01

    # Get Object with Internet Gateway
    #
    $Object = $Objects | Where-Object { -not [string]::IsNullOrEmpty($_.IpV4Gateway) }

    # $Object
    Write-Host "IPv4 = " $Object.IPv4Address " Default Gateway = " $Object.IpV4Gateway

    ### Return a Property
    #
    # $aProp = $Object | Select-Object -ExpandProperty FrendlyName
    # $aProp = $Object | Select-Object -ExpandProperty Index
    # $aProp = $Object | Select-Object -ExpandProperty MACAddress
    $aProp = $Object | Select-Object -ExpandProperty Name
