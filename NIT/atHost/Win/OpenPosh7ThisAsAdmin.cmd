@echo on
rem *******************************************************
rem OpenTerminalThisAsAdmin.cmd
rem This Script Opens Terminal Window at Current Folder as Administrator
rem *******************************************************
@echo off
...
rem
set CURRENTDIR=%~dp0
set EXPLOREREXE="C:\Program Files\PowerShell\7\pwsh.exe"
...
echo Run Payload...
rem
%EXPLOREREXE% -NoLogo -NoExit -Command cd %CURRENTDIR%
