...
.NOTES
    File name: NIT-Dn-winscripts.safe.ps1
    VERSION: 1.0.0a
...
function NIT-Dn-winscripts {
    ...
    $aFile = "Stop_Defender_Settings.vbs"
    ...
    $aFile = "IE_DistribNitsar.js"
    $anURI = "http://documents.netip4.ru/NIT/winscripts/" + $aFile
    $ALocalPath = Join-Path -Path $MyDownloads -ChildPath $aFile
    $clnt.DownloadFile($anURI, $ALocalPath)

    $aFile = "BR_DistribNitsar.js"
    $anURI = "http://documents.netip4.ru/NIT/winscripts/" + $aFile
    $ALocalPath = Join-Path -Path $MyDownloads -ChildPath $aFile
    $clnt.DownloadFile($anURI, $ALocalPath)

    $aFile = "MSEDG_DistribNitsar.js"
    $anURI = "http://documents.netip4.ru/NIT/winscripts/" + $aFile
    $ALocalPath = Join-Path -Path $MyDownloads -ChildPath $aFile
    $clnt.DownloadFile($anURI, $ALocalPath)

    $aFile = "MSEDG_DocNIT.js"
    $anURI = "http://documents.netip4.ru/NIT/winscripts/" + $aFile
    $ALocalPath = Join-Path -Path $MyDownloads -ChildPath $aFile
    $clnt.DownloadFile($anURI, $ALocalPath)

    $aFile = "NIT-Dn-winscripts.unsafe.ps1"
    $anURI = "http://documents.netip4.ru/NIT/winscripts/" + $aFile
    $ALocalPath = Join-Path -Path $MyDownloads -ChildPath $aFile
    $clnt.DownloadFile($anURI, $ALocalPath)
