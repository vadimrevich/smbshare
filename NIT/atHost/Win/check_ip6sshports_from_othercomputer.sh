#!/usr/bin/env bash
###########################################################
# check_ip6sshports_from_othercomputer.sh
...
sshpass -p $PASS ssh -p $SSHPORT $USER@$COMPUTER "/home/$USER/bin/check_ip6sshports_from_thiscomputer.sh $ADDRESS6" | grep 'Success'
PING=$?
